...
//     return 
//       FilledCardExample(enabled: false, name: ${(infos.name)}, url: {infos.url}, decs: {infos.decs}, useravarurl: result1.userAvatarUrl);}).toList();
...
//       List temp=[];
//              return infos.map((e) {
//               return FilledCardExample(enabled: false, name: e.map(e.name), url: e.url, decs: e.decs, useravarurl: "$(result1.userAvatarUrl)");
//   }).toList();
//     }
//     if (currentPage == 0) {
//       return Container(
...
//                   dimension: 30,
//                   child:Stack(children:[Image.asset("$(result1.userAvatorUrl)"),Icon(Icons.add_a_photo)])
//                 ) )  ,
